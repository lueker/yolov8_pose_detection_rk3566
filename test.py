...
RKNN_MODEL = './model/yolov8npose.rknn'
DATASET = './dataset.txt'

QUANTIZE_ON = True

CLASSES = ['door','pet bowl','base','weight scale', 'carpet', 'rag', 'sock', 'shoe', 'wire', 'dining table', 'chair', 'sofa', 'tea table', 'tv table', 'tv', 'refrigerator', 'bed', 'wardrobe', 'close stool', 'washing machine', 'marble', 'floor', 'zcj', 'base station', 'person', 'pet feces', 'bottle', 'ball', 'rubbish', 'tape', 'pencil', 'toy', 'bedside table', 'shoe rack', 'stool']
...
def export_rknn_inference(img):
    ...
    # pre-process config
    print('--> Config model')
    rknn.config(mean_values=[[0, 0, 0]], std_values=[[255, 255, 255]], quantized_dtype='asymmetric_quantized-8', quantized_method='channel',quantized_algorithm='normal', target_platform='rk3566')
    print('done')
